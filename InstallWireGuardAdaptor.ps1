...
$config_file_path = "C:\wireguard\wgserver.conf"
$adaptorname ="wgserver"


# Install WireGuard Adaptor name "wgserver"
Start-Process -Wait -FilePath $wireguard_exe_path -ArgumentList  "/installtunnelservice",$config_file_path

# Set "wgserver" network adaptor as private
$NetworkProfile = Get-NetConnectionProfile -InterfaceAlias $adaptorname 
...
#Enable NAT
Set-NetConnectionSharing $adaptorname $true
